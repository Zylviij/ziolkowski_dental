$( document ).ready( function() {
	if (!('ontouchstart' in window || 'onmsgesturechange' in window)) var s = skrollr.init();
	var d = new Date();
	var date = d.getDate();
	...
	$("form").submit(function(e){e.preventDefault(); var $this = $(this); $.post( $this.attr("action"), $this.serialize(), function(data) { return data }, "json");});
} );
